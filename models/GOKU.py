import models.GOKU_pixel_pendulum_friction as GOKU_pixel_pendulum_friction
import models.GOKU_pixel_pendulum as GOKU_pixel_pendulum
import models.GOKU_lv as GOKU_lv
...
def create_goku_lv(input_dim=4, latent_dim=64, rnn_input_dim=64, rnn_output_dim=64, ode_method='rk4', rnn_dropout=0.0, rnn_layers=2):
    return GOKU(input_dim, latent_dim, rnn_input_dim, rnn_output_dim, ode_method, rnn_dropout, rnn_layers, GOKU_lv.Encoder, GOKU_lv.Decoder)


def create_goku_pendulum(input_dim=[32, 32], latent_dim=16, rnn_input_dim=32, rnn_output_dim=16, ode_method='rk4', rnn_dropout=0.0, rnn_layers=2):
...
def create_goku_pixel_pendulum(input_dim=[28, 28], latent_dim=16, rnn_input_dim=32, rnn_output_dim=16, ode_method='rk4', rnn_dropout=0.0, rnn_layers=2):
    return GOKU(input_dim, latent_dim, rnn_input_dim, rnn_output_dim, ode_method, rnn_dropout, rnn_layers, GOKU_pixel_pendulum.Encoder, GOKU_pixel_pendulum.Decoder)


def create_goku_pixel_pendulum_friction(input_dim=[28, 28], latent_dim=16, rnn_input_dim=32, rnn_output_dim=16, ode_method='rk4', rnn_dropout=0.0, rnn_layers=2):
    return GOKU(input_dim, latent_dim, rnn_input_dim, rnn_output_dim, ode_method, rnn_dropout, rnn_layers, GOKU_pixel_pendulum_friction.Encoder, GOKU_pixel_pendulum_friction.Decoder)
